...
If installed via Snap, upgrade with `snap refresh claude-workspace`. If installed via `.deb` or `.rpm`, download the latest package from the [releases page](https://github.com/lamchakchan/claude-workspace/releases/latest) and reinstall.
