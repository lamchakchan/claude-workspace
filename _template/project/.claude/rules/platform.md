...
This file is auto-generated by `claude-workspace attach`. It provides platform-level conventions for Claude Code sessions. Customize or extend by adding additional `.md` files to `.claude/rules/`.
